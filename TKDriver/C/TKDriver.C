...
#define	  	AppType			     			0
#define	  	IsDoubleKey			 			1			  // 0 弹簧 1 隔空
#define	  	AirSeparationDistance	 	    2			 //0 单按键  1 双按键
#define   	CONFIRMTOUCHCNT        	        3			 //按键确认次数
#define   	INIT_AUTO_UPDATE_TIME	 	    4
#define   	SET_KEY_CONTI_TIME     	        5  			 //按键最长输出
...
unsigned long int TouchKeyScan(void)
{
    ...
    unsigned char data MultipleCnt = 0;//按键计数
